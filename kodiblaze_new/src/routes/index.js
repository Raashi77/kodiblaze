...
import Products from 'src/pages/post/Products';
import ViewProduct from 'src/pages/post/ViewProduct';
  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: 'blog/viewblog/:blogSlug', element: <ViewBlog /> },

        { path: 'products', element: <Products /> },
        { path: 'products/addProduct', element: <AddProduct /> },
        { path: 'products/viewProduct/:productSlug', element: <ViewProduct /> },
        {
          path: 'user',
          children: [
...
// Blog
const Blog = Loadable(lazy(() => import('../pages/blog/Blogs')));
const BlogNewPost = Loadable(lazy(() => import('../pages/blog/BlogAddEdit')));
// Product
const AddProduct = Loadable(lazy(() => import('../pages/post/AddPost')));